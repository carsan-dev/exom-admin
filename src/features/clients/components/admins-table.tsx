...
import { getUserDisplayName, type AdminUserListItem } from '../types'
...
export function AdminsTable({ admins, onEdit, onUnlock, onChangeRole, onToggleStatus }: AdminsTableProps) {
  return (
    <Table>
      <TableHeader>
        <TableRow>
          ...
          <TableRow key={admin.id}>
            ...
            <TableCell>
              <div className="flex flex-wrap justify-end gap-2">
                ...
                <Button variant="outline" size="sm" onClick={() => onChangeRole(admin)}>
                  <ShieldCheck className="h-4 w-4" />
                  Cambiar rol
                </Button>
                <Button variant="outline" size="sm" onClick={() => onToggleStatus(admin)}>
